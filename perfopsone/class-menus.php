	...
	class Menus {
		...
		public static function finalize() {
			if ( ! self::$initialized ) {
				...
				add_submenu_page( 'perfopsone-dashboard', esc_html__( 'Control Center', 'sessions' ), __( 'Control Center', 'sessions' ), 'manage_options', 'perfopsone-dashboard', [ self::class, 'get_settings_page' ] );
			}
