				...
				if ( ! self::$initialized ) {
					switch ( $menu ) {
						...
						case 'insights':
							...
							break;
						case 'records':
							add_submenu_page( 'perfopsone-dashboard', esc_html__( 'Catalogues', 'sessions' ), __( 'Catalogues', 'sessions' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_records_page' ] );
							break;
						case 'consoles':
